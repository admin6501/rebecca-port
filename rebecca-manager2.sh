...
change_image_tag() {
    ...
    echo -e "${YELLOW}Changing image tag to: $TARGET_TAG${NC}"

    confirm || return

    sed -i "s/image:.*/image: rebeccapanel\/rebecca:${TARGET_TAG}/" "$TARGET_FILE"
